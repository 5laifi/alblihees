...
export function Hero({ locale, profile, heroVideoUrl }: { locale: string; profile: ProfileData | null; heroVideoUrl?: string }) {
    ...
    return (
        <SectionWrapper className="relative lg:min-h-[80vh] lg:flex lg:items-center lg:justify-center overflow-hidden bg-background pb-0 md:pb-20">
            ...
            <div className="relative z-10 container pt-2 md:pt-10 pb-4 md:pb-0">
                ...
                <div className="block lg:hidden mb-4">
                    <div
                        ...
                        style={{ borderRadius: '30px', maxWidth: '250px' }}
                    >
                        <Image
                            src={imageUrl}
                            alt={heroName}
                ...
                <div className="flex flex-col lg:flex-row items-center justify-between gap-6 md:gap-12">
                    {/* Text Content */}
                    <div className="flex flex-col items-center lg:items-start text-center lg:text-start space-y-3 md:space-y-8 max-w-2xl">
                        <motion.div
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                            transition={{ duration: 0.5 }}
                        >
                            <h1 className="text-2xl sm:text-5xl md:text-7xl font-bold tracking-tight mb-2 sm:mb-4 leading-tight">
                                {heroName}
                            </h1>
                            <h2 className="text-sm sm:text-xl md:text-2xl font-medium text-accent mb-2 md:mb-6">
                                {heroTitle}
                            </h2>
                        ...
                        <motion.div
                            ...
                            className="flex flex-col sm:flex-row gap-2 sm:gap-3 pt-3 md:pt-4 justify-center w-full sm:w-auto"
                        >
                            <Button asChild size="lg" className="text-sm sm:text-base md:text-lg px-5 md:px-8 h-10 sm:h-12 md:h-14">
                                <Link href="/contact">
                                    {commonT("contactNow")}
                                </Link>
                            </Button>
                            <Button asChild variant="outline" size="lg" className="text-sm sm:text-base md:text-lg px-5 md:px-8 h-10 sm:h-12 md:h-14 gap-2">
